                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="space-y-4 md:space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <Link to="/" class="text-sm font-medium hover:underline text-white">Forgot password?</Link>
                        </div>
                        
                        {/* submit button */}
                        <button type="submit" class="w-full text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-primary-700 focus:ring-primary-800">Sign in</button>
                        <p class="text-sm font-light text-gray-400">
                            Don't have an account yet? <Link to="/signup" class="font-medium hover:underline text-primary-500">Sign up</Link>
                        </p>
                    </div>
